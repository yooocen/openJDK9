...
static jvmtiError JNICALL
jvmti_GetNamedModule(jvmtiEnv* env,
...
static jvmtiError JNICALL
jvmti_AddModuleReads(jvmtiEnv* env,
            jobject module,
            jobject to_module) {
...
static jvmtiError JNICALL
jvmti_AddModuleExports(jvmtiEnv* env,
            jobject module,
            const char* pkg_name,
            jobject to_module) {
...
static jvmtiError JNICALL
jvmti_AddModuleOpens(jvmtiEnv* env,
            jobject module,
            const char* pkg_name,
            jobject to_module) {
...
static jvmtiError JNICALL
jvmti_AddModuleUses(jvmtiEnv* env,
            jobject module,
            jclass service) {
...
static jvmtiError JNICALL
jvmti_AddModuleProvides(jvmtiEnv* env,
            jobject module,
            jclass service,
            jclass impl_class) {
...
static jvmtiError JNICALL
jvmti_IsModifiableModule(jvmtiEnv* env,
            jobject module,
...
struct jvmtiInterface_1_ jvmti_Interface = {
      ...
      jvmti_ResumeThreadList,
                              /*   94 : Add Module Reads */
      jvmti_AddModuleReads,
                              /*   95 : Add Module Exports */
      jvmti_AddModuleExports,
                              /*   96 : Add Module Opens */
      jvmti_AddModuleOpens,
                              /*   97 : Add Module Uses */
      jvmti_AddModuleUses,
                              /*   98 : Add Module Provides */
      jvmti_AddModuleProvides,
                              /*   99 : Is Modifiable Module */
      jvmti_IsModifiableModule,
