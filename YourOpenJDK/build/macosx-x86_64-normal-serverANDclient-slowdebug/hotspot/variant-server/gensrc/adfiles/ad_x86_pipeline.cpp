...
const Pipeline *               leaPPosIdxScaleNode::pipeline_class() { return (&pipeline_class_007); }
const Pipeline *               leaPPosIdxScaleNode::pipeline() const { return (&pipeline_class_007); }
...
const Pipeline *             compareAndSwapP_0Node::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *             compareAndSwapP_0Node::pipeline() const { return (&pipeline_class_039); }
...
const Pipeline *             compareAndSwapL_0Node::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *             compareAndSwapL_0Node::pipeline() const { return (&pipeline_class_039); }
...
const Pipeline *             compareAndSwapI_0Node::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *             compareAndSwapI_0Node::pipeline() const { return (&pipeline_class_039); }

const Pipeline *               compareAndSwapBNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *               compareAndSwapBNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *             compareAndSwapB_0Node::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *             compareAndSwapB_0Node::pipeline() const { return (&pipeline_class_039); }

const Pipeline *               compareAndSwapSNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *               compareAndSwapSNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *             compareAndSwapS_0Node::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *             compareAndSwapS_0Node::pipeline() const { return (&pipeline_class_039); }
...
const Pipeline *             compareAndSwapN_0Node::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *             compareAndSwapN_0Node::pipeline() const { return (&pipeline_class_039); }

const Pipeline *           compareAndExchangeBNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *           compareAndExchangeBNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *           compareAndExchangeSNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *           compareAndExchangeSNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *           compareAndExchangeINode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *           compareAndExchangeINode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *           compareAndExchangeLNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *           compareAndExchangeLNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *           compareAndExchangeNNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *           compareAndExchangeNNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *           compareAndExchangePNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *           compareAndExchangePNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *                  xaddB_no_resNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *                  xaddB_no_resNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *                         xaddBNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *                         xaddBNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *                  xaddS_no_resNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *                  xaddS_no_resNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *                         xaddSNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *                         xaddSNode::pipeline() const { return (&pipeline_class_039); }
...
const Pipeline *                         xchgBNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *                         xchgBNode::pipeline() const { return (&pipeline_class_039); }

const Pipeline *                         xchgSNode::pipeline_class() { return (&pipeline_class_039); }
const Pipeline *                         xchgSNode::pipeline() const { return (&pipeline_class_039); }
...
const Pipeline *                rep_stos_largeNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                rep_stos_largeNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               string_compareLNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               string_compareLNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               string_compareUNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               string_compareUNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              string_compareLUNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              string_compareLUNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              string_compareULNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              string_compareULNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           string_indexof_conLNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           string_indexof_conLNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           string_indexof_conUNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           string_indexof_conUNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *          string_indexof_conULNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *          string_indexof_conULNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               string_indexofLNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               string_indexofLNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               string_indexofUNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               string_indexofUNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              string_indexofULNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              string_indexofULNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *          string_indexofU_charNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *          string_indexofU_charNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                 array_equalsBNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                 array_equalsBNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                 array_equalsCNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                 array_equalsCNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                 has_negativesNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                 has_negativesNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               string_compressNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               string_compressNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                string_inflateNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                string_inflateNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *    jmpLoopEnd_and_restoreMaskNode::pipeline_class() { return (&pipeline_class_038); }
const Pipeline *    jmpLoopEnd_and_restoreMaskNode::pipeline() const { return (&pipeline_class_038); }

const Pipeline *   jmpLoopEndU_and_restoreMaskNode::pipeline_class() { return (&pipeline_class_038); }
const Pipeline *   jmpLoopEndU_and_restoreMaskNode::pipeline() const { return (&pipeline_class_038); }

const Pipeline * jmpLoopEndUCF_and_restoreMaskNode::pipeline_class() { return (&pipeline_class_038); }
const Pipeline * jmpLoopEndUCF_and_restoreMaskNode::pipeline() const { return (&pipeline_class_038); }
...
const Pipeline *                       setMaskNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                       setMaskNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *             absF_reg_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *             absF_reg_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *     absF_reg_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *     absF_reg_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *             absD_reg_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *             absD_reg_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *     absD_reg_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *     absD_reg_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                    onspinwaitNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                    onspinwaitNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                      fmaD_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      fmaD_regNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                      fmaF_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                      fmaF_regNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                 loadV64_dwordNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                 loadV64_dwordNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                 loadV64_qwordNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                 loadV64_qwordNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                storeV64_dwordNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                storeV64_dwordNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                storeV64_qwordNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                storeV64_qwordNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *              Repl2F_zero_evexNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *              Repl2F_zero_evexNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *              Repl4F_zero_evexNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *              Repl4F_zero_evexNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *              Repl8F_zero_evexNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *              Repl8F_zero_evexNode::pipeline() const { return (&pipeline_class_023); }
...
const Pipeline *              Repl2D_zero_evexNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *              Repl2D_zero_evexNode::pipeline() const { return (&pipeline_class_023); }

const Pipeline *              Repl4D_zero_evexNode::pipeline_class() { return (&pipeline_class_023); }
const Pipeline *              Repl4D_zero_evexNode::pipeline() const { return (&pipeline_class_023); }
...
const Pipeline *                vadd4B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd4B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd4B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd4B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd4B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd4B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vadd4B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd4B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd4B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd4B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd4B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd4B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vadd8B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd8B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd8B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd8B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd8B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd8B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vadd8B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd8B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd8B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd8B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd8B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd8B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *               vadd16B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd16B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vadd16B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vadd16B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vadd16B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vadd16B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd16B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd16B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vadd16B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vadd16B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vadd16B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vadd16B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd32B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd32B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vadd32B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vadd32B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vadd32B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vadd32B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd32B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd32B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vadd32B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vadd32B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vadd32B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vadd32B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vadd2S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd2S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd2S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd2S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd2S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd2S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vadd2S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd2S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd2S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd2S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd2S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd2S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vadd4S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd4S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd4S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd4S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd4S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd4S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vadd4S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd4S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd4S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd4S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd4S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd4S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vadd8S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd8S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd8S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd8S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd8S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd8S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vadd8S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vadd8S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd8S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd8S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vadd8S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vadd8S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd16S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd16S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vadd16S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vadd16S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vadd16S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vadd16S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vadd16S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vadd16S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vadd16S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vadd16S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vadd16S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vadd16S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsub4B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub4B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub4B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub4B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub4B_reg_exex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub4B_reg_exex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vsub4B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub4B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub4B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub4B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub4B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub4B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsub8B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub8B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub8B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub8B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub8B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub8B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vsub8B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub8B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub8B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub8B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub8B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub8B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *               vsub16B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub16B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsub16B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsub16B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsub16B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsub16B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub16B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub16B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsub16B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsub16B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsub16B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsub16B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub32B_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub32B_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsub32B_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsub32B_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsub32B_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsub32B_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub32B_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub32B_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsub32B_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsub32B_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsub32B_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsub32B_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsub2S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub2S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub2S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub2S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub2S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub2S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vsub2S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub2S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub2S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub2S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub2S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub2S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsub4S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub4S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub4S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub4S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub4S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub4S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vsub4S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub4S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub4S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub4S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub4S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub4S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsub8S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub8S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub8S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub8S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub8S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub8S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vsub8S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsub8S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub8S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub8S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsub8S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsub8S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub16S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub16S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsub16S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsub16S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsub16S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsub16S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsub16S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsub16S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsub16S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsub16S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsub16S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsub16S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vmul2S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vmul2S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul2S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul2S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vmul2S_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vmul2S_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vmul2S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vmul2S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul2S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul2S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vmul2S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vmul2S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vmul4S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vmul4S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul4S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul4S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vmul4S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vmul4S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vmul4S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vmul4S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul4S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul4S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vmul4S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vmul4S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vmul8S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vmul8S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul8S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul8S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vmul8S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vmul8S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                vmul8S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vmul8S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul8S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul8S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vmul8S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vmul8S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul16S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul16S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vmul16S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vmul16S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vmul16S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vmul16S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vmul16S_mem_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vmul16S_mem_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vmul16S_mem_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vmul16S_mem_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vmul16S_mem_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vmul16S_mem_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                   vcmov4D_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vcmov4D_regNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                   vsqrt2D_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vsqrt2D_regNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                   vsqrt2D_memNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vsqrt2D_memNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                   vsqrt4D_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vsqrt4D_regNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                   vsqrt4D_memNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vsqrt4D_memNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                   vsqrt8D_regNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vsqrt8D_regNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *                   vsqrt8D_memNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                   vsqrt8D_memNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsll2S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsll2S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsll2S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsll2S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsll2S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsll2S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsll2S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsll2S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsll2S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsll2S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsll2S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsll2S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsll4S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsll4S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsll4S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsll4S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsll4S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsll4S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsll4S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsll4S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsll4S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsll4S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsll4S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsll4S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsll8S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsll8S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsll8S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsll8S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsll8S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsll8S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsll8S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsll8S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsll8S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsll8S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsll8S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsll8S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsll16S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsll16S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsll16S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsll16S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsll16S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsll16S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsll16S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsll16S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *          vsll16S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *          vsll16S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *  vsll16S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *  vsll16S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsrl2S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsrl2S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsrl2S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsrl2S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsrl2S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsrl2S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsrl2S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsrl2S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsrl2S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsrl2S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsrl2S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsrl2S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsrl4S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsrl4S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsrl4S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsrl4S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsrl4S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsrl4S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsrl4S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsrl4S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsrl4S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsrl4S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsrl4S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsrl4S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsrl8S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsrl8S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsrl8S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsrl8S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsrl8S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsrl8S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsrl8S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsrl8S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsrl8S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsrl8S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsrl8S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsrl8S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsrl16S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsrl16S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsrl16S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsrl16S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsrl16S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsrl16S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsrl16S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsrl16S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *          vsrl16S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *          vsrl16S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *  vsrl16S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *  vsrl16S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsra2S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsra2S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsra2S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsra2S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsra2S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsra2S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsra2S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsra2S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsra2S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsra2S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsra2S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsra2S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsra4S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsra4S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsra4S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsra4S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsra4S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsra4S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsra4S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsra4S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsra4S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsra4S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsra4S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsra4S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
...
const Pipeline *                vsra8S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *                vsra8S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsra8S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsra8S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *       vsra8S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *       vsra8S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *            vsra8S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *            vsra8S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsra8S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsra8S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *   vsra8S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *   vsra8S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *               vsra16S_reg_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *               vsra16S_reg_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *              vsra16S_reg_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *              vsra16S_reg_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *      vsra16S_reg_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *      vsra16S_reg_evex_specialNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *           vsra16S_reg_imm_avxNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *           vsra16S_reg_imm_avxNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *          vsra16S_reg_imm_evexNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *          vsra16S_reg_imm_evexNode::pipeline() const { return (&pipeline_class_040); }

const Pipeline *  vsra16S_reg_imm_evex_specialNode::pipeline_class() { return (&pipeline_class_040); }
const Pipeline *  vsra16S_reg_imm_evex_specialNode::pipeline() const { return (&pipeline_class_040); }
