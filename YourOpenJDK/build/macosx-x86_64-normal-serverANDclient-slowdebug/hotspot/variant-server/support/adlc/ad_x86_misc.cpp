...
const RegMask &xaddB_no_resNode::out_RegMask() const { return (RegMask::Empty); }
const RegMask &xaddBNode::out_RegMask() const { return (INT_REG_mask()); }
const RegMask &xaddS_no_resNode::out_RegMask() const { return (RegMask::Empty); }
...
const RegMask &string_indexofU_charNode::out_RegMask() const { return (INT_RBX_REG_mask()); }
...
const RegMask &has_negativesNode::out_RegMask() const { return (INT_RAX_REG_mask()); }
...
const RegMask &jmpLoopEnd_and_restoreMaskNode::out_RegMask() const { return (RegMask::Empty); }
const RegMask &jmpLoopEndU_and_restoreMaskNode::out_RegMask() const { return (RegMask::Empty); }
const RegMask &jmpLoopEndUCF_and_restoreMaskNode::out_RegMask() const { return (RegMask::Empty); }
...
const RegMask &setMaskNode::out_RegMask() const { return (INT_REG_mask()); }
...
const RegMask &absF_reg_reg_evexNode::out_RegMask() const { return (FLOAT_REG_mask()); }
const RegMask &absF_reg_reg_evex_specialNode::out_RegMask() const { return (FLOAT_REG_mask()); }
...
const RegMask &absD_reg_reg_evexNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
const RegMask &absD_reg_reg_evex_specialNode::out_RegMask() const { return (DOUBLE_REG_mask()); }
...
const RegMask &loadV64_dwordNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &loadV64_qwordNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &storeV64_dwordNode::out_RegMask() const { return (RegMask::Empty); }
const RegMask &storeV64_qwordNode::out_RegMask() const { return (RegMask::Empty); }
...
const RegMask &Repl2F_zero_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &Repl4F_zero_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl8F_zero_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &Repl2D_zero_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &Repl4D_zero_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd4B_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_reg_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4B_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd8BNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8B_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd16BNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16B_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd32B_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd32B_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vadd2S_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_reg_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd2S_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vadd4SNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd4S_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vadd8SNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd8S_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vadd16S_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vadd16S_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vsub4B_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub4B_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub4B_reg_exex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub4B_mem_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub4B_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub4B_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub8BNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8B_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8B_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8B_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8B_mem_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8B_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8B_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub16BNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16B_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16B_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16B_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16B_mem_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16B_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16B_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub32B_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub32B_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub32B_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub32B_mem_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub32B_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub32B_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vsub2S_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub2S_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub2S_reg_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub2S_mem_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub2S_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub2S_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsub4SNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub4S_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub4S_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub4S_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub4S_mem_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub4S_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub4S_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsub8SNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub8S_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub8S_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub8S_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub8S_mem_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub8S_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub8S_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsub16S_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub16S_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub16S_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub16S_mem_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub16S_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsub16S_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vmul2S_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul2S_mem_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vmul4SNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul4S_mem_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vmul8SNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul8S_mem_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vmul16S_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vmul16S_mem_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vcmov4D_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vsqrt2D_regNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsqrt2D_memNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsqrt4D_regNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsqrt4D_memNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsqrt8D_regNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
const RegMask &vsqrt8D_memNode::out_RegMask() const { return (VECTORZ_REG_mask()); }
...
const RegMask &vsll2S_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsll2S_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsll2S_reg_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsll2S_reg_imm_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsll2S_reg_imm_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsll2S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vsll4S_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsll4S_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsll4S_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsll4S_reg_imm_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsll4S_reg_imm_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsll4S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsll8S_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsll8S_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsll8S_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsll8S_reg_imm_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsll8S_reg_imm_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsll8S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsll16S_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsll16S_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsll16S_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsll16S_reg_imm_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsll16S_reg_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsll16S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vsrl2S_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsrl2S_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsrl2S_reg_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsrl2S_reg_imm_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsrl2S_reg_imm_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsrl2S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vsrl4S_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsrl4S_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsrl4S_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsrl4S_reg_imm_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsrl4S_reg_imm_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsrl4S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsrl8S_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsrl8S_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsrl8S_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsrl8S_reg_imm_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsrl8S_reg_imm_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsrl8S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsrl16S_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsrl16S_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsrl16S_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsrl16S_reg_imm_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsrl16S_reg_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsrl16S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
...
const RegMask &vsra2S_reg_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsra2S_reg_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsra2S_reg_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsra2S_reg_imm_avxNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsra2S_reg_imm_evexNode::out_RegMask() const { return (VECTORS_REG_mask()); }
const RegMask &vsra2S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORS_REG_mask()); }
...
const RegMask &vsra4S_reg_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsra4S_reg_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsra4S_reg_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsra4S_reg_imm_avxNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsra4S_reg_imm_evexNode::out_RegMask() const { return (VECTORD_REG_mask()); }
const RegMask &vsra4S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORD_REG_mask()); }
...
const RegMask &vsra8S_reg_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsra8S_reg_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsra8S_reg_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsra8S_reg_imm_avxNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsra8S_reg_imm_evexNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsra8S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORX_REG_mask()); }
const RegMask &vsra16S_reg_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsra16S_reg_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsra16S_reg_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsra16S_reg_imm_avxNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsra16S_reg_imm_evexNode::out_RegMask() const { return (VECTORY_REG_mask()); }
const RegMask &vsra16S_reg_imm_evex_specialNode::out_RegMask() const { return (VECTORY_REG_mask()); }
