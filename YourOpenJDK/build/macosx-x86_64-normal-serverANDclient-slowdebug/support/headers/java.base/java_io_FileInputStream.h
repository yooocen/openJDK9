...
#undef java_io_FileInputStream_DEFAULT_BUFFER_SIZE
#define java_io_FileInputStream_DEFAULT_BUFFER_SIZE 8192L
#undef java_io_FileInputStream_MAX_BUFFER_SIZE
#define java_io_FileInputStream_MAX_BUFFER_SIZE 2147483639L
/*
