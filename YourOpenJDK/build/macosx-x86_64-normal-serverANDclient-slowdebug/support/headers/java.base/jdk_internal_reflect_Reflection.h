 ...
 */
JNIEXPORT jclass JNICALL Java_jdk_internal_reflect_Reflection_getCallerClass__
  (JNIEnv *, jclass);
 ...
 */
JNIEXPORT jclass JNICALL Java_jdk_internal_reflect_Reflection_getCallerClass__I
  (JNIEnv *, jclass, jint);
